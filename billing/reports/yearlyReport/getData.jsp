...
try {
    ...
    if (allYears) {
        ...
        // Merge both into a year-keyed ordered map
        ...
        for (int i = 0; i < salesVec.size(); i++) {
            ...
            double[] arr = dataMap.containsKey(yr) ? dataMap.get(yr) : new double[]{0, 0, 0};
        ...
        for (Map.Entry<Integer, double[]> entry : dataMap.entrySet()) {
            ...
            sb.append("{")
              ...
              .append("\"cumProfit\":").append(String.format("%.2f", cumProfit))
              .append("}");
        }
