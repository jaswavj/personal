...
<table id="printTable" class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0; font-size: 12px;">
    <thead style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%);">
        <tr>
            ...
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem; width: 180px; max-width: 180px; width: 180px; max-width: 180px;">Customer Name</th>
            <!--th>Discount</th-->
    ...
    <tbody>
        ...
        <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
            ...
            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem; max-width: 180px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><a href="https://wa.me/<%=cusPhone%>" target="_blank" style="color: #25D366; text-decoration: none; font-weight: 500; display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<%=row.elementAt(14)%>"><%=row.elementAt(14)%></a></td>
...
%>
    <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
        ...
        <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem; max-width: 180px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<%= cusName %>"><%= cusName %></td>
