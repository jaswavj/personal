    ...
    <div class="footer-row" style="border-bottom: none;">
        ...
        <div class="desc-box">
            ...
            <div  style="text-align: left; align-items: flex-start;" class="rightBorder">
                <ul class="terms-list">
                    <li>Software charges include installation and initial basic training only.</li>
                    <li>Full payment must be completed on the installation day.</li>
                    <li>Future updates, new features, custom reports, or additional work will be charged separately.</li>
                    <li>Online/Cloud software charges must be paid once every 3 months.</li>
                    <li>Delay or missing cloud payment may cause software license expiration or temporary access suspension.</li>
                    <li>Additional support, training, or customization may involve extra charges.</li>
                    <li>Customer is responsible for maintaining proper data backup.</li>
                    <li>By using this software, the customer agrees to the above terms and conditions.</li>
                </ul>
            </div>
        </div>
