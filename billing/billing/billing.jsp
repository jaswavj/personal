...
<!-- Bill Description Modal -->
<div class="modal fade" id="billDescModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" style="max-width:420px">
        <div class="modal-content" style="border-radius:10px;overflow:hidden">
            <div class="modal-header" style="background:var(--navy);color:#fff;padding:12px 16px">
                <h6 class="modal-title mb-0"><i class="fa fa-file-lines me-2"></i>Bill Description</h6>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="resetSaveBtn()"></button>
            </div>
            <div class="modal-body p-3">
                <label class="form-label fw-semibold mb-1" style="font-size:13px">Description <span class="text-muted fw-normal">(optional)</span></label>
                <textarea id="billDescInput" class="form-control" rows="3" placeholder="Enter bill description or remarks..." style="font-size:13px;resize:none"></textarea>
            </div>
            <div class="modal-footer p-2" style="gap:8px">
                <button type="button" class="bb bb-outline" data-bs-dismiss="modal" onclick="resetSaveBtn()">Cancel</button>
                <button type="button" class="bb bb-navy" id="confirmSaveBillBtn" onclick="doSaveBill()">
                    <i class="fa-regular fa-floppy-disk me-1"></i> Save Bill
                </button>
            </div>
        </div>
    </div>
